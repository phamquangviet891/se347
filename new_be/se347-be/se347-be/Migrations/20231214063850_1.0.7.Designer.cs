...
namespace se347_be.Migrations
{
    ...
    [Migration("20231214063850_1.0.7")]
    partial class _107
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("se347_be.Model.SqlCartItem", b =>
                {
                    b.HasOne("se347_be.Model.SqlOrder", null)
            ...
            modelBuilder.Entity("se347_be.Model.SqlReview", b =>
                {
                    b.HasOne("se347_be.Model.SqlProduct", null)
                        .WithMany("reviews")
                        .HasForeignKey("SqlProductID");
