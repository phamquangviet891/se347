  ...
  return (
    <div className="flex-1 p-4 h-full flex flex-col">
      <Card className="p-4 mb-4 h-[100px]">
        <h1>Home / Product / Add a New Product</h1>
                    ...
                    <div class="w-5/12 mt-6 mr-12">
                      ...
                      <div class="inline-block relative w-4/6">
                        ...
                        >
                          ...
                          <MenuItem value="ADN">ADN</MenuItem>
                          <MenuItem value="ADS">ADS</MenuItem>
                          <MenuItem value="ALOE">ALOE</MenuItem>
                          <ListSubheader>
                                  ...
                                  <TableRow>
                                    ...
                                    >
                                      <div className="flex justify-center items-center ">
                                        <AiOutlinePicture className="text-[#1A88F7] w-24 h-24 p-5 border-2 border-dashed	border-[#6EB6FF]" />
                                      </div>
                                    </TableCell>
                                    <TableCell
                                      align="center"
